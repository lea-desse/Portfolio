  ...
  return (
    <footer id="contact" className="py-32 bg-slate-950 relative border-t border-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pl-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          <div>
            ...
            <div className="space-y-6">
              <a href={`mailto:${CV_DATA.email}`} className="flex items-center gap-6 p-6 rounded-3xl bg-white border border-slate-200 hover:border-green-500 transition-all group shadow-2xl">
              ...
              <div className="flex gap-4">
                <a href={CV_DATA.socials.linkedin} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center p-6 rounded-3xl bg-white border border-slate-200 hover:border-green-500 transition-all font-black text-[10px] uppercase tracking-widest text-slate-900 hover:text-green-600 shadow-xl">
                  LinkedIn_Profile
                </a>
                <a 
          ...
          <div className="bg-white p-10 md:p-14 rounded-[3rem] border-2 border-slate-200 shadow-2xl relative overflow-hidden group">
            {/* Background design */}
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="relative">
                  ...
                  <input 
                    ...
                    name="name"
                    type="text" 
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-5 focus:outline-none focus:border-green-500 transition-all font-black text-sm text-slate-900 placeholder-slate-300" 
        ...
        <div className="mt-40 pt-12 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-8 text-slate-500 text-[9px] font-black uppercase tracking-[0.4em]">

  ...
  return (
    <footer id="contact" className="py-32 bg-slate-950 relative border-t border-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pl-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          <div>
            ...
            <div className="space-y-6">
              <a href={`mailto:${CV_DATA.email}`} className="flex items-center gap-6 p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-green-500 transition-all group shadow-2xl">
              ...
              <div className="flex gap-4">
                <a href={CV_DATA.socials.linkedin} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-green-500 transition-all font-black text-[10px] uppercase tracking-widest text-white hover:text-green-400 shadow-2xl">
                  LinkedIn_Profile
                </a>
                <a href={CV_DATA.socials.github} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-green-500 transition-all font-black text-[10px] uppercase tracking-widest text-white hover:text-green-400 shadow-2xl">
                  GitHub_Lab
                </a>
              </div>
            </div>
          ...
          <div className="bg-slate-900 p-10 md:p-14 rounded-[3rem] border-2 border-slate-800 shadow-2xl relative overflow-hidden group">
            {/* Background design */}
        ...
        <div className="mt-40 pt-12 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-8 text-slate-600 text-[9px] font-black uppercase tracking-[0.4em]">
